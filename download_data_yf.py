...
import numpy as np
import itertools
from technicalIndicators import ATR, CO, MACD, MFI, momentum, normalized_ATR, OBV, HTS
from talib import abstract as ta


x = ['RELIANCE.NS', 'TATASTEEL.NS', 'HDFCBANK.NS', 'INFY.NS',
     'BAJAJ-AUTO.NS', 'ICICIBANK.NS', 'ITC.NS',  'UPL.NS',
     'ONGC.NS', 'HINDALCO.NS', 'TITAN.NS', 'COALINDIA.NS',
     'INDUSINDBK.NS', 'BAJAJFINSV.NS', 'GRASIM.NS', 'JSWSTEEL.NS'
     ]

nifty50 = ['ADANIENT.NS', 'ADANIPORTS.NS', 'APOLLOHOSP.NS', 'ASIANPAINT.NS', 'AXISBANK.NS', 'BAJAJ-AUTO.NS', 
           ...
           'HEROMOTOCO.NS', 'HINDALCO.NS', 'HINDUNILVR.NS','HDFC.NS', 'ICICIBANK.NS', 'ITC.NS', 'INDUSINDBK.NS', 'INFY.NS',
           'JSWSTEEL.NS', 'KOTAKBANK.NS', 'LT.NS', 'M&M.NS', 'MARUTI.NS', 'NTPC.NS', 'NESTLEIND.NS', 'ONGC.NS', 'POWERGRID.NS', 
           'RELIANCE.NS', 'SBILIFE.NS', 'SBIN.NS', 'SUNPHARMA.NS', 'TCS.NS', 'TATACONSUM.NS', 'TATAMOTORS.NS', 'TATASTEEL.NS',
           'TECHM.NS', 'TITAN.NS', 'UPL.NS', 'ULTRACEMCO.NS', 'WIPRO.NS']

y = ['BTC-USD', 'ETH-USD', 'ADA-USD', 'DOGE-USD', 'SOL1-USD', 'LTC-USD', 'BNB-USD', 'AVAX-USD', 'UNI3-USD',
     'DOT1-USD', 'SUSHI-USD', 'LINK-USD', 'XRP-USD', 'ALGO-USD', 'EOS-USD',
     'XTZ-USD', 'FIL-USD', 'ATOM1-USD', 'TRX-USD', 'MATIC-USD', 'CHZ-USD', 'FTT1-USD', 'NEAR-USD',
     'SAND-USD', 'WAVES-USD', 'IOST-USD', 'DASH-USD', 'STORJ-USD', 'ZEC-USD', 'KSM-USD']
z = ['GC=F', 'SI=F', 'HG=F', 'PL=F', 'PA=F', 'CL=F', 'NG=F', 'RB=F',
     'HO=F', 'BZ=F', 'KC=F', 'SB=F', 'CT=F', 'HE=F', 'LE=F', 'GOLD']
